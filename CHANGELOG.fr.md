...
### Architecture
- `gf_harmonizer_smoke_test` fait passer de l'audio réel dans l'insert de l'harmonizer et vérifie la marge de crête, la continuité des blocs à toutes les tailles de salve qu'un appareil peut fournir, et la régularité du gain sur toute la plage d'intervalles. Lancé par `scripts/run_smoke_tests.sh`. Face à la 2.17.4, il échoue à trois de ses quatre contrôles — aucun n'était visible depuis la suite Dart.
