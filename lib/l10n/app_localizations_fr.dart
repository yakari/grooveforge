...
class AppLocalizationsFr extends AppLocalizations {
  ...
  String get guideMidiFxBody =>
      'L\'Harmonizer ajoute jusqu\'à quatre voix d\'harmonie à tout ce que vous jouez. Count règle le nombre de voix, et Voice 1 à Voice 4 règlent chaque intervalle en demi-tons — l\'affichage sous chaque potentiomètre nomme l\'intervalle, ainsi +7 st se lit comme une quinte juste. Par défaut, deux voix à la tierce majeure et à la quinte juste. Avec Scale Lock activé, ces intervalles s\'ajustent pour rester dans la gamme en cours : l\'harmonie suit la tonalité au lieu d\'en sortir.\nLes autres modules MIDI FX se placent au même endroit, entre un clavier et son son : Chord Expand transforme chaque note en accord complet, Arpeggiator égrène les notes tenues en rythme, Transposer décale le tout jusqu\'à deux octaves, Velocity Curve remappe la dynamique du jeu, Gate filtre les notes par vélocité ou par tessiture, et Microtone fond les notes tenues en une seule hauteur microtonale.';
  ...
  String audioLooperMemoryCapWarning(String usedMb, int capMb) {
    return 'Mémoire du looper audio : $usedMb Mo / $capMb Mo — pensez à effacer les clips inutiles';
  }
  ...
  @override
  String get rackAddNativeOnlyBadge => 'Applis uniquement';

  @override
  String get rackAddNativeOnlyTooltip =>
      'Disponible dans les applis GrooveForge pour Android, Linux, macOS et Windows, pas dans cette démo web.';
  ...
  String get rackAddXenSubtitle =>
      'Verrouille le clavier sur une gamme et le réaccorde — maqam, raga, gamelan, tempéraments anciens (effet MIDI)';
  ...
  @override
  String get xenFamilyExperimental => 'Expérimental';
  ...
  @override
  String get drumGeneratorFamilyMarch => 'Marche';
  ...
  @override
  String get drumGeneratorFamilyArabic => 'Arabe';

  @override
  String get drumGeneratorFamilyTurkish => 'Turc';

  @override
  String get drumGeneratorFamilyPersian => 'Persan';

  @override
  String get drumGeneratorFamilyIndian => 'Indien';

  @override
  String get drumGeneratorFamilyFarEast => 'Extrême-Orient';
  ...
  @override
  String get ccAssignAddValue => 'Assigner une valeur…';
