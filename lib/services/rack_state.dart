    ...
    for (final entry in _midiFxInstances.entries) {
      ...
      for (final e in events) {
        ...
        if (e.isNoteOn) {
          ...
          // Microtone and any future bend-driven FX rely on this path —
          // without it, pitch-bend events generated by tick() are silently
          // dropped and the downstream synth never receives the retuning.
          _engine.setPitchBend(channel: ch, value: e.pitchBendValue);
        }
      }
    }
  }
