...
/// A utility for parsing Soundfont (SF2) files to extract available instrument presets.
///
/// It reads the RIFF structure of the `.sf2` file, locates the `pdta` (Preset Data) chunk,
/// and extracts the headers to build a structured mapping of:
/// Bank -> Program -> Preset Name.
class Sf2Parser {
